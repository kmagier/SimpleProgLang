...
class TestParser ( Parser ):
    ...
    class ProgContext(ParserRuleContext):
        ...
        def stat(self, i:int=None):
            if i is None:
                return self.getTypedRuleContexts(TestParser.StatContext)
            else:
                return self.getTypedRuleContext(TestParser.StatContext,i)
    ...
    def prog(self):
        ...
        try:
            ...
            while True:
                ...
                self._errHandler.sync(self)
                _la = self._input.LA(1)
                if not ((((_la) & ~0x3f) == 0 and ((1 << _la) & ((1 << TestParser.T__1) | (1 << TestParser.ID) | (1 << TestParser.INT) | (1 << TestParser.NEWLINE))) != 0)):
                    break
    ...
    class BlankContext(StatContext):
        ...
        def __init__(self, parser, ctx:ParserRuleContext): # actually a TestParser.StatContext
    ...
    def stat(self):
        ...
        localctx = TestParser.StatContext(self, self._ctx, self.state)
        ...
        try:
            ...
            if la_ == 1:
                localctx = TestParser.PrintExprContext(self, localctx)
                self.enterOuterAlt(localctx, 1)
                self.state = 11
                self.expr(0)
                self.state = 12
                ...
                localctx = TestParser.AssignContext(self, localctx)
                ...
                localctx = TestParser.BlankContext(self, localctx)
    ...
    class AddSubContext(ExprContext):
        ...
        def SUB(self):
            return self.getToken(TestParser.SUB, 0)
    ...
    def expr(self, _p:int=0):
        ...
        try:
            ...
            if token in [TestParser.INT]:
                localctx = TestParser.IntContext(self, localctx)
                self._ctx = localctx
                _prevctx = localctx
                ...
                pass
            elif token in [TestParser.ID]:
                localctx = TestParser.IdContext(self, localctx)
                self._ctx = localctx
                _prevctx = localctx
                self.state = 24
                self.match(TestParser.ID)
                ...
                localctx = TestParser.ParensContext(self, localctx)
                self._ctx = localctx
                _prevctx = localctx
                self.state = 25
            ...
            while _alt!=2 and _alt!=ATN.INVALID_ALT_NUMBER:
                if _alt==1:
                    ...
                    if la_ == 1:
                        localctx = TestParser.MulDivContext(self, TestParser.ExprContext(self, _parentctx, _parentState))
                        ...
                        _la = self._input.LA(1)
                        if not(_la==TestParser.MUL or _la==TestParser.DIV):
                        ...
                        localctx = TestParser.AddSubContext(self, TestParser.ExprContext(self, _parentctx, _parentState))
                        self.pushNewRecursionContext(localctx, _startState, self.RULE_expr)
                        self.state = 34
                        ...
                        localctx.op = self._input.LT(1)
                        _la = self._input.LA(1)
                        if not(_la==TestParser.ADD or _la==TestParser.SUB):
                            localctx.op = self._errHandler.recoverInline(self)
                        else:
                            self._errHandler.reportMatch(self)
                            self.consume()
